...
```vue
<Field v-if="data.type === 'physical'" name="weight" v-slot="{ errors, errorMessage, handleChange }">
  <!-- field content -->
</Field>
```
...
const toolbarItems = computed(() => {
  const items: IBladeToolbar[] = [{ id: "save", title: "Save", icon: "save", onClick: handleSave }];
